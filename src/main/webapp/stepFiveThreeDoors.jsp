...
<a href="stepSixFirstDoor.jsp" class="btn btn-danger">Вторая дверь<span class="glyphicon glyphicon-circle-arrow-right"></span></a>
<a href="stepSixFirstDoor.jsp" class="btn btn-danger">Третья дверь<span class="glyphicon glyphicon-circle-arrow-right"></span></a>
</body>
</html>
